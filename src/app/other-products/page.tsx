...
import { ChevronRight, Leaf, Droplets, Sprout, TrendingUp, Shield, Users, Phone, Mail, MapPin } from 'lucide-react';
...
export default function GobarCompostPage() {
 ...
 const benefits = [
    { icon: <Sprout className="w-6 h-6" />, text: 'Improves soil structure and aeration' },
    { icon: <Droplets className="w-6 h-6" />, text: 'Enhances water retention capacity' },
    { icon: <Leaf className="w-6 h-6" />, text: 'Promotes beneficial microbial activity' },
    { icon: <TrendingUp className="w-6 h-6" />, text: 'Supports strong root development' },
    { icon: <Shield className="w-6 h-6" />, text: 'Improves crop yield and quality' },
    { icon: <Users className="w-6 h-6" />, text: 'Safe for long-term soil use' },
  ];
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-green-200 mb-10 max-w-3xl mx-auto animate-fade-in-up animation-delay-400">
            Supporting healthier crops, improved soil fertility, and sustainable agricultural practices through naturally decomposed cow dung compost.
          </p>
    ...
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              ...
              composting processes. It enriches soil naturally, improves
              nutrient availability, and supports healthy crop growth without
              harming soil structure.
            </p>

            <p className="text-lg text-gray-700 leading-relaxed">
              This fertilizer is suitable for suran cultivation, vegetables,
              fruits, and multiple agricultural crops, making it ideal for both
      ...
      <section 
        ...
        className={`py-10 px-4 bg-gradient-to-br from-green-50 to-white transition-all duration-1000 ${
          isVisible['section-composition'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-green-900 mb-4">Natural Composition</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <h3 className="text-2xl font-bold text-green-800 mb-6">Ingredients</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <h3 className="text-2xl font-bold text-green-800 mb-6">Available Forms</h3>
              <div className="space-y-6">
                <div className="border-l-4 border-green-500 pl-6 hover:border-green-700 transition-colors">
                  <h4 className="font-bold text-xl text-green-700 mb-2">Powder Form</h4>
                  <p className="text-gray-600">Easy to spread and mix</p>
                </div>
                <div className="border-l-4 border-green-500 pl-6 hover:border-green-700 transition-colors">
                  <h4 className="font-bold text-xl text-green-700 mb-2">Paste / Semi-Solid Form</h4>
                  <p className="text-gray-600">Suitable for soil application and plantation preparation</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section 
        ...
        className={`py-10 px-4 transition-all duration-1000 ${
          isVisible['section-benefits'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, idx) => (
              ...
              >
                ...
                <p className="text-gray-700 font-medium text-lg">{benefit.text}</p>
              </div>
            ))}
            ...
            <div className="group bg-gradient-to-br from-green-500 to-green-700 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 text-white">
              ...
              <p className="font-medium text-lg">✔ Eco-friendly and sustainable</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section 
        ...
        className={`py-10 px-4 bg-gradient-to-br from-green-900 to-green-800 text-white transition-all duration-1000 ${
          isVisible['section-crops'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Suitable Applications</h2>
            <div className="w-20 h-1 bg-green-400 mx-auto mb-6" />
            <p className="text-xl text-green-100">
              Gobar Compost Fertilizer can be used across multiple crops and farming systems
            </p>
          </div>
      ...
      <section 
        ...
        className={`py-10 px-4 transition-all duration-1000 ${
          isVisible['section-application'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
      >
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-green-900 mb-4">How to Use</h2>
            <div className="w-20 h-1 bg-green-600 mx-auto" />
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-white rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="mt-8 p-6 bg-yellow-50 border-l-4 border-yellow-500 rounded-r-xl">
              <p className="text-yellow-800 font-medium">
                <span className="font-bold">Note:</span> Detailed application guidance is provided during consultation based on farming requirements.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl p-8 shadow-xl">
                ...
                <p className="text-gray-700 text-lg">
                  Our Gobar Compost Fertilizer supports environmentally responsible farming by improving soil health naturally and reducing dependence on chemical inputs.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <h4 className="text-xl font-bold text-green-800 mb-3">🌱 Long-term Cultivation</h4>
                <p className="text-gray-600">Aligns with sustainable planning for future generations</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <h4 className="text-xl font-bold text-green-800 mb-3">🏆 Export-Grade Practices</h4>
                <p className="text-gray-600">Supports healthier produce and quality standards</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <h4 className="text-xl font-bold text-green-800 mb-3">💚 Soil Management</h4>
                <p className="text-gray-600">Natural approach to maintaining soil vitality</p>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-green-900 mb-6">Our Quality Approach</h2>
          <div className="w-20 h-1 bg-green-600 mx-auto mb-12" />

          <div className="grid md:grid-cols-4 gap-6">
            {[
              { icon: '⚙️', title: 'Controlled Composting', desc: 'Process excellence' },
              { icon: '✅', title: 'Quality Standards', desc: 'Consistent results' },
              { icon: '🛡️', title: 'Safe Inputs', desc: 'Natural & tested' },
              { icon: '👨‍🌾', title: 'Farmer Support', desc: 'Modern & traditional' }
            ].map((item, idx) => (
              <div
                key={idx}
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-600">
            Organic compost powder products supporting soil health and sustainable farming
          </p>
        </div>
      ...
      <section className="py-10 px-4 bg-gradient-to-br from-green-600 via-green-700 to-green-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-green-100 mb-10">
            Learn how this natural fertilizer can support your farming goals and soil health.
          </p>
