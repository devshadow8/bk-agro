  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    >
      ...
      <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
        ...
        quality-controlled farming, and reliable domestic and international
        distribution.
      </p>
    </motion.div>
  </div>
    ...
    <section className="relative py-20 bg-gradient-to-b from-white to-green-50/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              We work with a structured farming model where suran cultivation is planned, guided, and aligned with market requirements. Our role is to support the process across cultivation planning, quality handling, and market linkage.
            </p>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed mt-4">
              This approach helps reduce uncertainty through planning, transparency, and disciplined execution.
            </p>
          </motion.div>
      ...
      {/* 4. OUR APPROACH */}
        <section className="relative py-20 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-green-50/20">
            ...
            return (
              ...
              >
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group-hover:border-green-200">
                  ...
                  >
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${point.color} p-3 shadow-md group-hover:shadow-lg transition-shadow`}>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-black text-gray-900">Domestic Market</h3>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Primary focus on Maharashtra, where suran is widely consumed and traded through wholesale markets in <span className="font-semibold text-green-600">Mumbai, Pune, Nashik, and Nagpur</span>.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-black text-gray-900">International Market</h3>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Export supply to the <span className="font-semibold text-emerald-600">UAE</span> supports demand from Indian and Asian communities through established import and distribution channels.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="relative aspect-[21/9] rounded-2xl overflow-hidden shadow-2xl max-w-5xl mx-auto">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <h4 className="text-white text-2xl font-black">Global Distribution Network</h4>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Agriculture involves natural and market-related risks. Returns are not guaranteed and may vary based on farming conditions and market factors.
                </p>
              </div>
            </div>
          </motion.div>
